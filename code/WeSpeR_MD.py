...
class WeSpeR_MD(BaseEstimator, TransformerMixin):
    """
    ...
    def fit_from_F(self, lambda_, U, W, c = None, y=None, p_tau = None, tau_init = None, method = "root", n_epochs = 100, wt = None, d = torch.ones(1), wd = torch.ones(1), mu = 0.1, weights = 'Ndiracs', w_args = None, omega = 100, loss_type = 'trap', assume_centered = False, lr = 5e-2, momentum=0., verbose = True):
        """
        Estimate the covariance matrix from diagonalized form of the sample covariance.

        Parameters
        ----------
        lambda_ : array-like of shape (n_samples)
            Training sample eigenvalues.

        U : array-like of shape (n_features, n_features)
            Training sample eigenvectors.
    ...
    def fit_from_S(self, S, W, y=None, p_tau = None, c = None, tau_init = None, method = "root", n_epochs = 100, wt = None, d = torch.ones(1), wd = torch.ones(1), mu = 0.1, weights = 'Ndiracs', w_args = None, omega = 100, loss_type = 'trap', assume_centered = False, lr = 5e-2, momentum=0., verbose = True):
        """
    ...
    def fit(self, X, W, y=None, c = None, p_tau = None, tau_init = None, method = "root", n_epochs = 100, wt = None, d = torch.ones(1), wd = torch.ones(1), mu = 0.1, weights = 'Ndiracs', w_args = None, omega = 100, loss_type = 'trap', assume_centered = False, lr = 5e-2, momentum=0., verbose = True):
        """
